...
// legacy project key, no UUID — Coins and Medals shares the same entity
// list and catalogue shape as every other DXA gallery, so there is nothing
// of its own to feed in.
