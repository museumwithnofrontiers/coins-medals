...
export default {
  ...
  siteName: manifest.site?.names?.en ?? 'coins-medals',
  ...
  home: {
    title: 'coins.identity.title',
    intro: 'coins.home.intro',
    cards: [
      {
        title: 'coins.nav.catalogue',
        description: 'coins.home.catalogueText',
    ...
    featured: {
      entity: 'items',
      heading: 'coins.home.itemOnDisplay',
  ...
  navigation: {
    ...
    links: [
      ...
      { section: 'catalogue', label: 'coins.nav.catalogue', to: { name: 'catalogue' } },
      { section: 'about', label: 'coins.nav.about', to: { name: 'about' } },
    ],
  },
  ...
  //       partnerObjects: {
  //         emptyPartner: 'coins.partnerObjects.emptyPartner',
  //         emptyInstitution: 'coins.partnerObjects.emptyInstitution',
  //         institutionSummary: 'coins.partner.monumentsInExhibition',
  //         partnerProfileLabel: 'coins.partnerObjects.partnerProfile',
  //         institutionProfileLabel: 'coins.partnerObjects.institutionProfile',
  //       },
  //     }),
  //     // + this website's own routes: home, item, collection entrance,
  //     // timeline entrance, partners entrance
